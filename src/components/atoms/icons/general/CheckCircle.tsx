...
export const CheckCircle_Bold = forwardRef<SVGSVGElement, SVGIconProps>(
  ({ fillPath = "currentColor", pathProps, ...props }, ref) => {
    return (
      <svg
        width="24"
        height="24"
...
CheckCircle_Bold.displayName = "CheckCircle_Bold";
